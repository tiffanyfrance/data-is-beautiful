...
// function updateRadarChart(radarData, str, strNum, radarGraphData) {
//   let reviewCount = 0;

//   /* set radar data to 0 initially */
//   for (let d of radarData) {
//     d.value = 0;
//   }
...
//       for(let key in j[str]) {
//         /* matching radar axis to key in candidates */
//         let radarAxis = radarData.find(function(radarAxis) {
//           return radarAxis.axis === key;
//         });

//         radarAxis.value += j[str][key];
//       }
//     }
//   };
...
//   if (reviewCount) {
//     for (let d of radarData) {
//       d.value = Math.round(d.value / reviewCount);
//       d.value = Math.max(5, d.value);
//       avgScore += d.value;
//     }
//   }

//   avgScore = Math.round(avgScore / radarData.length);

//   $('#reviewCount' + strNum).text(reviewCount);
//   $('#averageScore' + strNum).text(avgScore + '%');

//   /* redraw radar chart with modified data */
//   RadarChart.draw("#radarChart" + strNum, radarGraphData);
// };